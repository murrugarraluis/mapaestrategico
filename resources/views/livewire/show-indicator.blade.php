    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="pb-4 text-center md:text-left">
                <h2 class="text-2xl font-semibold leading-tight">Indicadores de {{$process->name}}</h2>
            </div>
            <div class="flex flex-col items-center w-full md:flex-row">
                ...
                <div class="flex items-center">
                    @livewire('create-indicator',['process_id'=>$process->id])
                </div>
                                    ...
                                    @if ($indicator->trashed())
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm w-10">
                                            <div class="flex flex-col md:flex-row">
                                                <button wire:click="renovate({{ $indicator->id }})"
