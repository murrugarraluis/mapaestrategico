    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="pb-4 text-center md:text-left">
                <h2 class="text-2xl font-semibold leading-tight">Mapa Estrategico de {{$process->name}}</h2>
            </div>
...
{{--                        <button onclick="relayoutLanes()">Layout</button>--}}
                        <button id="SaveButton" onclick="save()" class="px-5 py-2 my-2 bg-gray-200 rounded-md hover:bg-gray-300">Guardar</button>
